from aempy.csp import AEMContentsManager
...
#  uses.
c.NotebookApp.tornado_settings = {'headers': {'Content-Security-Policy': 'frame-ancestors self http://localhost:4502',}}
...
##
c.ContentsManager.root_dir = 'notebooks'
